...
public class patients extends AppCompatActivity {
    ...
    private void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.patients:
                frag = MenuFragment.newInstance(getString(R.string.text_patients),
                        getColorFromRes(R.color.color_patients));
                break;
            case R.id.tasks:
                frag = MenuFragment.newInstance(getString(R.string.text_tasks),
                        getColorFromRes(R.color.color_tasks));
                break;
            case R.id.map:
                frag = MenuFragment.newInstance(getString(R.string.text_map),
                        getColorFromRes(R.color.color_maps));
                break;
        }
